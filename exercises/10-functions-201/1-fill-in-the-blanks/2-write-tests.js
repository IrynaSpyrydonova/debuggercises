...
const _1_actual = strictEqual(undefined, NaN);
console.assert(_1_actual === _1_expect, 'Test 1');

const _2_expect = false;
const _2_actual = strictEqual(0, null);
...
const _5_actual = strictEqual(-1, false);
console.assert(_5_actual === _5_expect, 'Test 5');

const _6_expect = true;
const _6_actual = strictEqual(-0.0, -0);
...
const _8_actual = strictEqual(0, false);
console.assert(_8_actual === _8_expect, 'Test 8');

const _9_expect = true;
const _9_actual = strictEqual(1, 1.0);
